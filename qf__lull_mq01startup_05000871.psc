...
if playerRef.getCurrentLocation()==farmLocation
Alias_Lull_MQ01SU_Llavados.getReference().moveto(dragonBridgeLocationCenter)
else
...
Location Property FarmLocation  Auto  

ObjectReference Property dragonBridgeLocationCenter  Auto  
